...
message_data = {
    ...
    Lang.EN: {
        ...
        MessageKey.REF_INVITED_STEP_ONE: "👥 You have invited <a href=\"tg://user?id={user_link}\">a friend!</a> You will receive 1500 $GMEME once your friend subscribes to the channels!",
    ...
    Lang.DE: {
        ...
        MessageKey.REF_INVITED_STEP_ONE: "👥 Sie haben <a href=\"tg://user?id={user_link}\">einen Freund!</a> eingeladen! Sie erhalten 1500 $GMEME, sobald Ihr Freund die Kanäle abonniert hat!",
    ...
    Lang.TR: {
        ...
        MessageKey.REF_INVITED_STEP_ONE: "👥 <a href=\"tg://user?id={user_link}\">Bir arkadaşınızı</a> davet ettiniz! Arkadaşınız kanallara abone olduğunda 1500 $GMEME kazanacaksınız!",
